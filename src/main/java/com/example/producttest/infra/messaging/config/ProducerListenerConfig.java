...
@Configuration
public class ProducerListenerConfig {

    @Value("${spring.kafka.bootstrap-servers}")
    private String bootstrapServer;

    @Value("${app.kafka.producer.group-id}")
    private String groupId;

    @Value("${app.kafka.listener.auto-offset}")
    ...
    public ConsumerFactory<String, Object> consumerFactory() {
        ...
        consumer.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JacksonJsonDeserializer.class);
        consumer.put(ConsumerConfig.GROUP_ID_CONFIG, groupId);
        consumer.put(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, autoOffset);
